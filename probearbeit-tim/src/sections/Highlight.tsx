  ...
  return (
    <div className='container relative py-10'>
      <div className='grid gap-y-0 rounded-lg overflow-hidden'>
        <div className='col-span-2 md:col-span-12 lg:col-span-8 order-1 lg:order-2 lg:-ml-8 lg:w-[calc(100%+32px)] '>
          <img
            src={HighlightImage}
            alt='highlight image'
        ...
        <div className='col-span-2 md:col-span-12 lg:col-span-4 order-2 lg:order-1 flex flex-col gap-6 lg:justify-between px-8 py-10 bg-product-f-blue-dark'>
